...
//       return false;
//   } else if (!checkAsciiCriteria(password, confirmPassword)) {
//       passwordError.textContent = 'Password criteria not met.';
//       return false;
...
// function checkAsciiCriteria(password, confirmPassword) {
//   const totalAsciiPassword = calculateTotalAscii(password);
//   const totalAsciiConfirmPassword = calculateTotalAscii(confirmPassword);

//   return totalAsciiPassword === totalAsciiConfirmPassword;
// }

// function calculateTotalAscii(str) {
//   let totalAscii = 0;
//   for (let i = 0; i < str.length; i++) {
//       totalAscii += str.charCodeAt(i);
//   }
//   return totalAscii;
// }
